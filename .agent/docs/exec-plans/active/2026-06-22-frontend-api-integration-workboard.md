...
- follow method와 follower/following 목록 연동 변경은 구현·검증·push가 끝났고 child repo draft PR merge가 남아 있다.
...
| `FEI-010` | follow method와 follower/following 목록 연동 | `VERIFY` | 없음 | backend PR #2, frontend PR #3 | backend 571, frontend 106 tests 통과 |
...
| 2026-06-22 | `FEI-010` | `VERIFY` | backend PR #2, frontend PR #3 | follow E2E와 전체 테스트 완료, draft PR merge 필요 |
