...
| `FEI-130` | `MyPage` 사용자·팔로우·저장 장소 mock 제거 | `DONE` | `FEI-010` | `develop` | PR 반영 완료 |
| `FEI-131` | `MyTripsPage` 무한 스크롤 및 탭 필터 동기화 버그 수정 | `DONE` | `FEI-130` | `feature/fei-131-my-trips-api` | PR 대기 |
| `FEI-140` | `RoutePage`의 `mockPlaces` fallback 제거 | `DONE` | `feature/route-api-integration` | `RoutePage.vue`, `MapboxItineraryMap.vue` | PR 대기 |
...
| 2026-06-22 | `FEI-130` | `DONE` | `develop` | MyPage 실제 API 연동 완료 (사용자, 팔로우, 저장 장소) |
| 2026-06-22 | `FEI-131` | `DONE` | `feature/fei-131-my-trips-api` | MyTripsPage 무한 스크롤 및 탭 필터 동기화 버그 수정 완료 |
| 2026-06-22 | `FEI-140` | `DONE` | `feature/route-api-integration` | RoutePage mockPlaces 제거 및 placeApi 연동 완료 |
...
| 2026-06-22 | frontend | `npm test -- --run` | 106 tests 통과 (FEI-140 수정 후) |
