...
- `.agent/docs/` 루트는 `index.md`만 허용하고 상세 문서는 역할별 하위 폴더에 둡니다.
...
4. 구조나 라우트가 바뀌면 `.agent/docs/frontend/page_map.md`를 갱신합니다.
...
- 운영 문서: `.agent/docs/process/branching_agent_docs.md`
- Git 운영 문서: `.agent/docs/process/git_workflow.md`
