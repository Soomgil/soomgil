...
| 하네스 운영 방식 | `.agent/docs/ai_harness_guide.md` |
| 브랜치별 AI 문서 | `.agent/docs/branching_agent_docs.md`, `.agent/branch-ledger/README.md` |
| 프론트 라우트와 페이지 | `.agent/docs/page_map.md`, `.agent/docs/generated/ui_inventory.md` |
| frontend/backend 책임 경계 | `.agent/docs/architecture_guide.md` |
| 제품 기능/API 이해 | `.agent/docs/functional_spec.md`, `.agent/docs/api_spec.md` |
...
5. 구조나 라우트가 바뀌면 `.agent/docs/page_map.md`와 생성 인벤토리를 갱신합니다.
